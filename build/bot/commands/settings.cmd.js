...
class SettingsCommand extends types_1.Command {
    constructor() {
        super({
            name: 'settings',
    ...
    handle(mes, args, repl) {
        index_1.Core.databaseManager.getGuildData(mes.guild).then(guilddata => {
            if (!guilddata) {
    ...
    subcmdChannel(orgmes, args, guilddata, reply) {
        if (args.length < 2) {
    ...
    subcmdMention(orgmes, args, guilddata, reply) {
        if (args.length < 2) {
    ...
    subcmdTheme(orgmes, args, guilddata, reply) {
        if (args.length < 2) {
    ...
    subcmdCurrency(orgmes, args, guilddata, reply) {
        if (args.length < 2) {
    ...
    subcmdReact(orgmes, args, guilddata, reply) {
        if (args.length < 2) {
    ...
    subcmdTrash(orgmes, args, guilddata, reply) {
        if (args.length < 2) {
    ...
    subcmdMinPrice(orgmes, args, guilddata, reply) {
        if (args.length < 2) {
...
//# sourceMappingURL=settings.cmd.js.map