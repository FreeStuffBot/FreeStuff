import { ChannelType, ButtonStyle, ComponentType, SlotableInteraction, InteractionApplicationCommandCallbackData, InteractionComponentFlag, MessageComponentSelectOption } from 'cordo'
...
export default async function (i: SlotableInteraction, [ opts ]: [ Options ]): Promise<InteractionApplicationCommandCallbackData> {
  ...
  // ISSUE: @everyone missing
  // ISSUE: deselect thing
  ...
  return {
    ...
    components: [
      ...
      },
      {
        ...
        custom_id: `subscriptions_${i.params.sub}_main`,
        label: '=generic_back',
      ...
      },
      {
        type: ComponentType.BUTTON,
        style: ButtonStyle.SECONDARY,
        custom_id: 'meta_add_role',
        label: '=subscriptions_notifications_add_role'
      }
    ],
